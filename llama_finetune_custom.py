...
class TrainingArguments():
    ...
    gradient_accumulation_steps: int = field(default=1), # number of forward steps before running a backward step
    ...
    report_to: str = field(default="none") # turn wandb off
...
model_id = "/vg_data/share/models/llama2-hf-converted/llama-2-70b"
...
trainer.save_model("/vg_data/share/models/llama2-hf-converted/fine_tuning_result/english_quotes/70b")
